...
public class MoveManager : MonoBehaviour
{
    ...
    public void PathFinding(Vector2Int rand)
    {
    ...
    public void MoveToPlayer()
    {
        if (FinalNodeList.Count > 1)
        {
            ...
            if (FinalNodeList[1].x - FinalNodeList[0].x > 0)
            {
                spinLeft = true;
                spinRight = false;
            }
            else if (FinalNodeList[1].x - FinalNodeList[0].x < 0)
            {
                spinLeft = false;
                spinRight = true;
            }
            ...
            if (FinalNodeList[1].y - FinalNodeList[0].y > 0)
            {
                spinUp = true;
                spinDown = false;
            }
            else if (FinalNodeList[1].y - FinalNodeList[0].y < 0)
            {
                spinUp = false;
                spinDown = true;
            }
